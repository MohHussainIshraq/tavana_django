...
class LoginForm(forms.Form):
    phone = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control'}), validators=[validators.MaxLengthValidator(12)])
    ...
    #     if len(phone) > 11:
    #         raise ValidationError('تلفون وارد شده معتبر نیست', code="invalid_phone")
